...
public class ImageController {
	...
	@PostMapping(value = "/users/{userId}/images", produces = { MediaType.APPLICATION_JSON })
	...
	@GetMapping(value = "/users/{userId}/images/{id}", produces = { MediaType.APPLICATION_JSON })
	...
	@GetMapping(value = "/users/{userId}/images", produces = { MediaType.APPLICATION_JSON })
	...
	@PostMapping(value = "/users/{userId}/images/archive/{id}", produces = { MediaType.APPLICATION_JSON })
	...
	@DeleteMapping(value = "/users/{userId}/images/{id}", produces = { MediaType.APPLICATION_JSON })
